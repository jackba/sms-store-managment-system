...
CREATE PROCEDURE SP_IMPORT_REPORTER_DETAIL
@KIND INT, 
@MA_KHO INT,
@MA_SAN_PHAM INT, 
@TEN_SAN_PHAM NVARCHAR(200),
...
CREATE PROCEDURE SP_IMPORT_REPORTER_SUM
@KIND INT, 
@MA_KHO INT,
@MA_SAN_PHAM INT, 
@TEN_SAN_PHAM NVARCHAR(200),
...
(
	...
	PERMISSION_LEVEL SMALLINT,  -- 1: METADATA  - 3 SALER -- 7 STORE MANAGE -- 15 ACCOUNTER -- 31 ADMIN
	UPDATE_AT DATE,
	ACTIVE CHAR(1)
)