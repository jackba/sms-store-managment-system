...
ALTER PROCEDURE [dbo].[SP_REPORT_BY_DAY]
@START_TIME DATE, 
@END_TIME DATE
AS
BEGIN
...
CREATE PROCEDURE [dbo].[SP_REPORT_BY_CUSTOMER]
@START_TIME DATE, 
@END_TIME DATE, 
@MA_KHACH_HANG INT, 
...
BEGIN
	...
	ORDER BY 
	CASE SALES.MA_KHU_VUC 
	WHEN NULL THEN
		RETURN_TABLE.MA_KHU_VUC
	ELSE SALES.MA_KHU_VUC  END , 
	ISNULL(SALES.TOTAL,0) - ISNULL(RETURN_TABLE.TOTAL,0) DESC,
	CASE SALES.MA_KHACH_HANG 
	WHEN NULL THEN
		RETURN_TABLE.MA_KHACH_HANG
	ELSE SALES.MA_KHACH_HANG  END
	
END

EXEC SP_REPORT_BY_CUSTOMER NULL, NULL, 0, NULL
