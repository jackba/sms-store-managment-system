...
namespace SMS.Models
{
    ...
    public partial class SmsContext : DbContext
    {
        ...
        public virtual int SP_EXPORT_4_RETURN_2_PROVIDER(Nullable<int> iD, Nullable<int> sTORE_ID, Nullable<int> uSER_ID, Nullable<System.DateTime> eXPORT_DATE, ObjectParameter rETURN_VALUE)
        {
            ...
            var eXPORT_DATEParameter = eXPORT_DATE.HasValue ?
                new ObjectParameter("EXPORT_DATE", eXPORT_DATE) :
                new ObjectParameter("EXPORT_DATE", typeof(System.DateTime));
        ...
        public virtual ObjectResult<SP_GET_EXPORT_DETAIL_BY_ID_Result> SP_GET_EXPORT_DETAIL_BY_ID(Nullable<int> iD)
        {
            var iDParameter = iD.HasValue ?
                new ObjectParameter("ID", iD) :
                new ObjectParameter("ID", typeof(int));
