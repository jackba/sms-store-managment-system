...
function onloadTotal() {
    $('input.quantity').each(function (event) {
        var $this = $(this);
        var parent = $this.parent().parent();
...
function addRow() {
    ...
    $('#detailTable > tbody:last').append('<tr> ' +
        ...
        '<td class="inner colwidth">' +
        '<input name="Details[' + row + '].SO_LUONG" class="arrowkey quantity textbtl numberic" id="Details_' + row + '__SO_LUONG" type="text" value="" data-val="true" data-val-number="The field SO_LUONG_TEMP must be a number."> </td>' +
        '<td class="innerLast colwidth">' +
        '<select name="Details[' + row + '].MA_DON_VI" class="arrowkey unit textbtl" id="Details_' + row + '__MA_DON_VI" style="padding: 5px; font-size: 1.2em;" data-val="true" data-val-number="The field MA_DON_VI must be a number.">' +
        '<td class="innerLast colwidth"><input name="Details[' + row + '].DON_GIA" class="arrowkey price numberic textbtl" id="Details_' + row + '__DON_GIA" type="text" value="" data-val="true" data-val-number="The field DON_GIA_TEMP must be a number."></td>' +
        ...
        '<td class="innerLast colwidth">' +
        '<select name="Details[' + row + '].MA_KHO_XUAT" class="arrowkey store textbtl" id="Details_ + row + __MA_KHO_XUAT" style="padding: 5px; font-size: 1.2em;" data-val="true" data-val-number="The field MA_KHO_XUAT must be a number."><option value="">---------</option>' +
        '</select></td>' +
        '</tr>');
    $("#rowIndex").val(row);
