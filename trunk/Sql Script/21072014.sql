CREATE PROCEDURE SP_GET_INVENTORY_BY_PRO_STO_ID
@PRODUCT_ID INT, 
@STORE_ID INT
AS
BEGIN
	SELECT ISNULL(DBO.F_GET_TON_KHO(@STORE_ID, @PRODUCT_ID),0) TON_KHO
END
...
BEGIN
	...
	WHERE
		...
		AND (XUAT_KHO.ACTIVE = 'A' OR XUAT_KHO.ACTIVE = 'W')
