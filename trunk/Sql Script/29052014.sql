ALTER PROCEDURE SP_GET_HOA_DON_CAN_XUAT_KHO
@MA_KHACH_HANG INT, 
...
ALTER PROCEDURE SP_GET_HD_DETAIL_FOR_EXPORT
@MA_KHO INT, 
@MA_HOA_DON INT
AS 
BEGIN
...
ALTER PROCEDURE SP_SALE_EXPORT
@MA_KHO INT, 
@MA_HOA_DON INT, 
	...
	BEGIN
		...
		BEGIN
			...
			BEGIN
				...
				FETCH NEXT FROM CHI_TIEC_HOA_DON_CURSOR1 INTO @MA_SAN_PHAM, @SO_LUONG, @DON_GIA, @NEXT_STORE_ID
				WHILE @@FETCH_STATUS = 0 
				BEGIN
