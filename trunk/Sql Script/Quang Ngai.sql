...
(	
	...
	LY_DO_XUAT SMALLINT, -- O: XUẤT BÁN HÀNG, 1: XUẤT HỦY, 2: XUẤT DÙNG NỘI BỘ, 3: XUẤT CHUYỂN KHO, 4: XUẤT TRẢ NHÀ CUNG CẤP
...
(
	...
	MA_KHO INT FOREIGN KEY REFERENCES KHO(MA_KHO), 
	LY_DO_NHAP SMALLINT, -- O: MUA HÀNG, 1: NHẬP LẠI HÀNG TRẢ, 2: KIỂM KHO, 3: NHẬP CHUYỂN KHO, 4: NHẬP ĐIỀU CHỈNH KHO
